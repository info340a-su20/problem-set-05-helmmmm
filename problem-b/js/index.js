...
*/
let inputElem = document.querySelector('#dobInput');
inputElem.addEventListener('input', function() {
  let value = inputElem.value;
  let age = getYearsSince(value);
  if (age < 13 || age > 200) {
    inputElem.setCustomValidity("You need to be at least 13 years old.");
...
let pwc = document.querySelector('#passwordConfirmInput');
let pwFeedback = document.querySelector('#passwordConfirmFeedback');
...
pwc.addEventListener('input', validatePasswordMatch);
